...
class ValantisSTEXLiquidityModule(LiquidityModule):
    ...
    def get_amount_in(
        ...
        if isZeroToOne:
            ...
            amount_in_without_fee = self.convert_to_token_0(output_amount, pool_state)
        ...
        # For token1 -> token0 swap
            ...
            return 0, self.convert_to_token_1(output_amount, pool_state)
    ...
    def get_tvl(self, pool_state: Dict, token: Optional[Token] = None) -> Decimal:
        ...
        amount_0_pending_lp_withdrawal: int = self.convert_to_token_0(amount_1_pending_lp_withdrawal, pool_state)
    ...
    def swap(self, input_token: Token, amount_in: int, pool_state: Dict, fixed_parameters: Dict) -> Tuple[int, int]:
        ...
        amount_out = self.convert_to_token_1(amount_in_without_fee, pool_state) if isZeroToOne else self.convert_to_token_0(amount_in_without_fee, pool_state)
        if isZeroToOne:
    ...
    def get_swap_fee_in_bips(self, token_in: Token, amount_in: int, pool_state: Dict, fixed_parameters: Dict) -> int:
        ...
        amount_1_lending_pool: int = pool_state['amount_1_lending_pool']
        reserves_1_total: int = SafeMath.add(reserves_token_1, amount_1_lending_pool)
        expected_amount_token_1_out = self.convert_to_token_1(amount_in, pool_state)
    ...
    def convert_to_token_0(self, amount_token_1: int, pool_state: Dict) -> int:
        exchange_rate = pool_state['exchange_rate_to_token_0']
        return amount_token_1 * exchange_rate
    
    def convert_to_token_1(self, amount_token_0: int, pool_state: Dict) -> int:
